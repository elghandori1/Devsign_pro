...
const STATIC_PATH_PATTERN = /^\/(_next|favicon|logo|images|cover|CV)/;
...
export const config = {
  matcher: [
    ...
    '/((?!api|_next/static|_next/image|favicon.ico|favicon-96x96.png|favicon.svg|apple-touch-icon.png|web-app-manifest-192x192.png|web-app-manifest-512x512.png|robots.txt|sitemap.xml|site.webmanifest|logo|cover|CV).*)',
  ],
};