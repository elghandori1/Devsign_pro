...
>
      ...
      >
        ...
        <div className="flex flex-col flex-grow p-6 sm:p-8">
          ...
          <div className="mb-3">
            <h4 className="text-xl sm:text-2xl font-bold group-hover:text-primary 
                         transition-colors duration-300 inline-block">
              {service.title}
            </h4>
            <div className="mt-1.5 h-0.5 w-8 bg-primary/40 group-hover:w-full 
          ...
          {/* Features */}
          <div className="flex flex-wrap gap-2 mb-5 lg:mb-7">
        ...
        <div
          ...
          style={{ transitionProperty: 'transform', transitionTimingFunction: 'ease-out' }}
        />
