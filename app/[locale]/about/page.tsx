              ...
              <div className={`space-y-8 ${isRtl ? "lg:order-2" : ""}`}>
                {[
                  ...
                  <div key={label} className="flex gap-4">
                    <div
                      className="w-10 h-10 rounded-xl bg-primary/10 flex items-center
      ...
      <section className="border-t border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <div className="relative rounded-2xl border border-primary/20 bg-card overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-primary/10 pointer-events-none" />
            <div
              className="absolute -top-16 left-1/2 -translate-x-1/2 w-64 h-64 bg-primary/10
