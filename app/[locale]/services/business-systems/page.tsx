  ...
  return (
    <main dir={isRtl ? "rtl" : "ltr"} className="min-h-screen bg-background">
      ...
      <section
        ...
        className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 lg:py-24"
      >
        {/* Overview Text */}
              ...
              {data.useCases.map(
                (uc: { title: string; text: string }, i: number) => {
                  ...
                  return (
                    <article
                      key={i}
                      className="group flex flex-col sm:flex-row items-start gap-4 p-5 sm:p-6 rounded-2xl border border-primary/40 bg-card hover:shadow-md transition-all duration-300"
                    >
              ...
              {data.benefits.map(
                (b: { title: string; text: string }, i: number) => {
                  ...
                  return (
                    <article
                      key={i}
                      className="relative p-6 sm:p-8 rounded-2xl border border-border bg-card shadow-sm hover:shadow-md hover:border-primary/30 overflow-hidden flex flex-col items-center text-center"
                    >
      ...
      {data.process?.length > 0 && (
        <section
          ...
          className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 border-t border-border"
        >
